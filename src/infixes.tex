...
is in fact a \kl{bounded language}. \todo[inline]{I think we can in fact construct chains that are not bounded languages. E.g. $ab, aba^2b, aba^2ba^3b, \ldots$?}

\todo[inline]{aliaume: yes, this way nonsense.}
