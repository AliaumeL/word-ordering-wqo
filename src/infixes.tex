...
\begin{corollary}
  ...
  \proofref{small-ordinal-invariants:thm}
    Let $L$ be a \kl{well-quasi-ordered} \kl{downwards closed} language for the \kl{infix relation}.
...
particular, it follows that one can decide if an \kl{automatic
sequence} is \kl{ultimately uniformly recurrent}, a proof of this folklore
