...
Let us recall some examples of \kl{amalgamation systems}
arising in the literature. 

\begin{example}
    Regular languages, context-free languages, and languages recognized by
    VASS are all recognized by amalgamation systems.
\end{example}
