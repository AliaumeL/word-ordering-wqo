...
\AP
Let us conclude this section with a few remarks on the notion of \kl{factor
...
that $f_L(n) \geq C^n$ for infinitely many $n \in \Nat$.
...
most a linear factor complexity, and \kl(morphic){morphic sequences} have at
most a polynomial factor complexity. In that sense, the
\cref{exponential-factor-complexity:lem} shows that one can still construct
``pathological'' examples of infinite words that are \kl{well-quasi-ordered}
for the \kl{infix relation}, but have a high factor complexity.
