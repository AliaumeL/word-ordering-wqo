...
\todo[inline]{What is the complexity of the reduction? Logspace? }
...
\begin{figure}
    \centering
    \todo[inline]{simplify the figure, only two letter initial word}
...
\begin{proof}
    ...
    \todo[inline]{This proof is not very satisfying.}
    Indeed, assume that
    ...
    \kl{regular languges} are closed under \kl{downwards closure}, we conclude
...
\todo[inline]{
    Add computing the \kl{ordinal invariants}
    of the \kl{infix relation} for languages 
    recognized by \kl{amalgamation systems}.
}
