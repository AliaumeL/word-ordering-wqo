...
This holds because for any $a^k$, the word $a^kb$ belongs to $L
...
\begin{theorem}
    ...
    \kl{prefix relation} if and only if $L$ is a finite union of \kl{chains}.
\end{theorem}
...
\begin{proof}
    ...
    and therefore $\oType{L_k} = k \cdot \omega$.\qedhere
\end{proof}
