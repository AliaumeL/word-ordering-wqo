...
by a monadic second order formula (\kl{$\MSO$-formula}), allowing us to
leverage the decidability of $\MSO$ over infinite binary trees \cite[Theorem
1.1]{RAB69}. This result will follow from our general decidability result in
\cref{amalgamation:sec} but serves as a good illustration.
