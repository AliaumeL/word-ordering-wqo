...
\begin{proofof}{antichain-branches-prefix:lem}
    ...
    an infinite branch. By definition this is an \kl{antichain branch}.\qedhere
\end{proofof}
...
\begin{proofof}{prefix-wqo-reg-decidable:cor}
	...
	trees
	\cite[Theorem 1.1]{RAB69}.\qedhere
\end{proofof}
...
\begin{proofof}{prefixes:thm}
    ...
    \begin{equation*}
        ...
        \quad .
    \end{equation*}
    Hence, $L$ is a finite union of \kl{chains}.
    \qedhere
\end{proofof}
...
\begin{proofof}{pumping-periods:lem}
    ...
    $\vec{n_{i+1}}$ having all components greater than $2\card{w[\vec{n_i}]}$.
...
\begin{proofof}{bi-infinite:lem}
    ...
    belongs to $L$ since $u_i \in L$ and $L$ is \kl{downward closed}.
    \qedhere
\end{proofof}
...
\begin{proofof}{ultimately-uniformly-recurrent:lem}
    ...
    $R_i \defined \mathsf{Rec}(w_{\geq i})$ is a descending sequence of \kl{downward
...
\begin{proofof}{automatic-wqo:thm}
...
\begin{proofof}{small-ordinal-invariants:thm}
    ...
    alphabet is at most $\omegaOrd$ for the \kl{infix ordering}. Let us now consider a
    \kl{well-quasi-ordered} language $L$ that is \kl{downward closed} for the
   ...
   We can then
    directly conclude that $\oWidth{L_i}$ is less than $\omegaOrd$ (in the case of
    a finite word), less than $\omegaOrd \cdot 2$ (in the case of an infinite
    word thanks to \cref{small-ordinal-invariants:lem}), or less than $
    \omegaOrd \cdot 3$ (in the case of a bi-infinite word, thanks to
...
\begin{proofof}{infix-amalgamation:thm}
    ...
    As $\InfPeriodChain{w}$ is a \kl{bounded language} and this property is stable under subsets, concatenation and finite union,
...
\begin{proofof}{dwclosed-infixes-wqo:lem}
    ...
    is simply because a \kl{downward closed} language 
    that is a finite union of products of \kl{chains} is a regular language.

    Indeed, assume that
    $L$ is \kl{downward closed} and included in a finite union of sets of the form
    ...
    \kl{downward closed}. Now, because $L'$ is a \kl{regular language}, and 
...
\section{Proofs for Section~\ref{conclusion:sec}}

\begin{lemma}
  \label{dwclosed-wqo-complexity-width-finite:lem}
  Let $L$ be a \kl{downward closed} language that is
  \kl{well-quasi-ordered} by the \kl{infix relation}.
  Then, the following are equivalent:
  \begin{enumerate}
    \item $L$ has bounded \kl{factor complexity},
      \label{dwclosed-wqo-complexity-width-finite:item1}
    \item $L$ has finite \kl{ordinal width},
      \label{dwclosed-wqo-complexity-width-finite:item2}
    \item $L$ is a finite union of \kl{chains},
...
\begin{proof}
  ...
  fact regarding \kl{ordinal width}.
  ...
  ultimately periodic words have bounded \kl{factor complexity}.
  ...
  unbounded \kl{factor complexity} implies the existence of arbitrarily
  large \kl{antichains}.
  ...
  of \cref{dw-closed-wqo-charac:thm} and the fact that bounded \kl{factor
  complexity} implies that the (bi)infinite words describing the language
  are \kl{ultimately periodic}.
  \qedhere
\end{proof}
