...
\begin{lemma}
  ...
  \begin{enumerate}
    ...
    \item $L$ is a finite union 
      ...
      $\infset{w}$ where $w$
      is an \kl{ultimately periodic} word.
      \label{dwclosed-wqo-complexity-width-finite:item3}
  \end{enumerate}
\end{lemma}
\begin{proof}
  \cref{dwclosed-wqo-complexity-width-finite:item3} $\Rightarrow$
  \cref{dwclosed-wqo-complexity-width-finite:item1} is clear because
  \kl{ultimately periodic} words have bounded \kl{factor complexity}.

  \cref{dwclosed-wqo-complexity-width-finite:item1} $\Rightarrow$
