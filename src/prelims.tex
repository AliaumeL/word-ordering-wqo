...
As an example, for $(\Nat, \leq)$, all bad sequences are descending and antichains have size at most $1$. Therefore the maximal order type and the ordinal height of $\Nat$ are $\omega$ and the ordinal width is $1$. \todo{Please check this!}
