...
Such a straightforward characterization will however remain elusive for the \kl{infix relation}. For example, Kuske~\cite{DBLP:journals/ita/Kuske06} has shown that any countable partial order with finite downward closures can be embedded into it. Therefore, the structure of the \kl{infix relation} must be as least as complex as the \kl{subword relation}. However, not all is lost: we show that with some mild restrictions we can recover much of the simple structure of the \kl[prefix relation]{prefix} and \kl{suffix relation}:
...
This is not an overly onerous restriction: \kl[amalgamation system]{Amalgamation systems} are a recently introduced notion that 
...
self-contained, we study the \kl{prefix relation} and prove in \cref{prefixes:thm}
the characterization of \kl{well-quasi-ordered} languages by the \kl{prefix
relation}. In \cref{infixes-regular:sec}, we obtain the \kl[infix relation]{infix} analogue of
...
\kl{amalgamation systems} in \cref{infixes-amalgamation:sec} in 
